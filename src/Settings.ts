...
const Settings = {
    ...
    getAuthEmail: () => {
        ...
        if (authEmailProjectConfig) {
            Logger.warn(
                "Save your auth email in the global config to keep it secure (learn more here: https://github.com/texterify/texterify-cli#authentication)."
            );
    ...
    getAuthSecret: () => {
        ...
        if (authSecretProjectConfig) {
            Logger.warn(
                "Save your auth secret in the global config to keep it secure (learn more here: https://github.com/texterify/texterify-cli#authentication)."
            );
